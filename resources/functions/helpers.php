...
if ( ! function_exists( 'dev_svg_icon' ) ) {
...
if ( ! function_exists( 'dev_the_posts_navigation' ) ) {
	function dev_the_posts_navigation( $args = array(), $base = false, $query = false ) {
