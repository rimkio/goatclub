...
if ( ! function_exists( 'dev_template_news_hero_header' ) ) {
	function dev_template_news_hero_header() {
        ...
        <div class="news-hero text-center text-white">
            <div class="container">
                <div class="hero-inner">
                    <h2 class="dev-title">Blog</h2>
                    <p class="dev-subtitle"><?= get_bloginfo( 'description' ); ?></p>
                </div>
            </div>
        </div>
